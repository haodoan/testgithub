...
void setup()
{
    ...
    */
    UART2_Init((uint32_t)115200, UART2_WORDLENGTH_8D, UART2_STOPBITS_2, UART2_PARITY_NO,
    ...
    // Reset GPS Cold mde
    //ATcommand("AT+CGPSRST=1", "OK", 2000);
...
uint8_t HTTP_Send(char *gprmc_data , char *IMEI)
{
    ...
    if (answer == 1)
    {
        ...
        answer = sendATcommand("AT+HTTPACTION=0", "+HTTPACTION:0,200", 120000);
    }
